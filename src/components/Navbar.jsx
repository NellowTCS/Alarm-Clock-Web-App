...
const Navbar = ({ current, setCurrent }) => {
  ...
  return (
    <nav className="relative flex justify-around py-3 bg-pink-100/50 backdrop-blur-md shadow-lg px-2 overflow-hidden">
        ...
        return (
          <button
            ...
            className={`
              ...
              focus:outline-none focus:ring-2 focus:ring-inset focus:ring-pink-200
              ${
                isActive
                  ? "text-pink-500 scale-105 -translate-y-1"
