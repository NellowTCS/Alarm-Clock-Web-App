    ...
    <div className="relative flex flex-col items-center justify-center w-full h-full bg-white bg-opacity-80 backdrop-blur-xl rounded-2xl p-6 pt-28">
      ...
      <div className="flex items-center gap-0 mt-8 bg-pink-50 bg-opacity-30 backdrop-blur-md rounded-full shadow-md px-3 py-2 hover:bg-pink-100 transition-colors duration-200">
        <input
          ...
          className="w-16 h-8 text-center bg-transparent focus:outline-none focus:ring-2 focus:ring-pink-200 rounded-l-full transition"
        />
        ...
        <input
          ...
          className="w-16 h-8 text-center bg-transparent focus:outline-none focus:ring-2 focus:ring-pink-200 transition"
        />
        <span className="px-1 text-gray-600 select-none">:</span>
        <input
          type="number"
          ...
          className="w-16 h-8 text-center bg-transparent focus:outline-none focus:ring-2 focus:ring-pink-200 rounded-r-full transition"
        />
        <button
          onClick={setTimer}
